...
COMMENT ON FUNCTION "public"."is_admin"() IS 'Check if current user is an admin. Used in RLS policies. Security: search_path fixed on 2025-11-18.';
...
CREATE TABLE IF NOT EXISTS "public"."document_investors" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "created_by" "text",
    CONSTRAINT "document_investors_investor_type_check" CHECK (("investor_type" = ANY (ARRAY['org'::"text", 'user'::"text"])))
);


ALTER TABLE "public"."document_investors" OWNER TO "postgres";
...
ALTER VIEW "public"."transaction_documents_view" OWNER TO "postgres";


COMMENT ON VIEW "public"."transaction_documents_view" IS 'Joins transaction document files with document metadata. SECURITY INVOKER ensures RLS is enforced for the calling user.';
...
ALTER TABLE ONLY "public"."document_investors"
    ADD CONSTRAINT "document_investors_document_path_bucket_name_investor_type__key" UNIQUE ("document_path", "bucket_name", "investor_type", "investor_id");



ALTER TABLE ONLY "public"."document_investors"
    ADD CONSTRAINT "document_investors_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "Admin and assigned users can manage tasks" ON "public"."tasks" TO "authenticated" USING ((EXISTS ( SELECT 1
  ...
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND (("acu"."role" = 'admin'::"public"."user_role_internal") OR ("acu"."id" = "tasks"."assigned_to"))))));



CREATE POLICY "Admin can access all appraisals" ON "public"."appraisal" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can manage borrower" ON "public"."borrower" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));



CREATE POLICY "Admin can manage company" ON "public"."company" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can manage contact type junctions" ON "public"."contact_contact_types" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can manage contacts" ON "public"."contact" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can manage document role assignments" ON "public"."document_roles_files" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can manage loan_application" ON "public"."loan_application" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can manage payroll fees" ON "public"."payroll_ledger_fees_1099" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));



CREATE POLICY "Admin can manage payroll submissions" ON "public"."payroll_ledger" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));



CREATE POLICY "Admin can manage property" ON "public"."property" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admin can select all bsi_deals_clerk_users" ON "public"."bsi_deals_clerk_users" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admins can delete distributions" ON "public"."bsi_distributions" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
  ...
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admins can manage transfer-vendor matches" ON "public"."api_brex_transfers_vendors" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admins can update statements" ON "public"."bsi_statements" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Authenticated users can delete document_investors" ON "public"."document_investors" FOR DELETE USING (("auth"."jwt"() IS NOT NULL));



CREATE POLICY "Authenticated users can insert document_investors" ON "public"."document_investors" FOR INSERT WITH CHECK (("auth"."jwt"() IS NOT NULL));



CREATE POLICY "Authenticated users can update document_investors" ON "public"."document_investors" FOR UPDATE USING (("auth"."jwt"() IS NOT NULL));



CREATE POLICY "Authenticated users can view document_investors" ON "public"."document_investors" FOR SELECT USING (("auth"."jwt"() IS NOT NULL));
...
CREATE POLICY "Balance sheet investors can insert their own statements" ON "public"."bsi_statements" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("acu"."role" = 'balance_sheet_investor'::"public"."user_role_internal") AND ("bsi_statements"."auth_clerk_users_id" = "acu"."id")))));
...
CREATE POLICY "Balance sheet investors can select their statements" ON "public"."bsi_statements" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "acu"
  WHERE (("acu"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND (("acu"."role" = 'admin'::"public"."user_role_internal") OR (("acu"."role" = 'balance_sheet_investor'::"public"."user_role_internal") AND ("bsi_statements"."auth_clerk_users_id" = "acu"."id")))))));
...
CREATE POLICY "Only admins can delete bsi_deals_clerk_orgs" ON "public"."bsi_deals_clerk_orgs" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal")))));



CREATE POLICY "Only admins can insert bsi_deals_clerk_orgs" ON "public"."bsi_deals_clerk_orgs" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal")))));



CREATE POLICY "Only admins can update bsi_deals_clerk_orgs" ON "public"."bsi_deals_clerk_orgs" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Org members and admins can read distributions" ON "public"."bsi_distributions" FOR SELECT USING ((EXISTS ( SELECT 1
  ...
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND (("p"."role" = 'admin'::"public"."user_role_internal") OR ("m"."clerk_org_id" = "bsi_distributions"."clerk_org_id"))))));
...
CREATE POLICY "Org members and admins can read instrument-deal links" ON "public"."bs_debt_instruments_deals" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ((("public"."bsi_deals_clerk_users" "d"
     JOIN "public"."bsi_deals_clerk_orgs" "dorg" ON (("dorg"."deal_id" = "d"."id")))
  ...
  WHERE (("d"."id" = "bs_debt_instruments_deals"."deal_id") AND ("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND (("p"."role" = 'admin'::"public"."user_role_internal") OR ("m"."clerk_org_id" = "dorg"."clerk_org_id"))))));
...
CREATE POLICY "Users can link documents to their transactions" ON "public"."bsi_transactions_document_files" FOR INSERT WITH CHECK (((EXISTS ( SELECT 1
   FROM ("public"."bsi_transactions" "t"
     JOIN "public"."bsi_transactions_investors" "ti" ON (("t"."id" = "ti"."transaction_id")))
  WHERE (("t"."id" = "ti"."transaction_id") AND ("ti"."clerk_user_id" IN ( SELECT "auth_clerk_users"."id"
           FROM "public"."auth_clerk_users"
          WHERE ("auth_clerk_users"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text"))))))) OR (EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users"
  WHERE (("auth_clerk_users"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("auth_clerk_users"."role" = 'admin'::"public"."user_role_internal"))))));
...
CREATE POLICY "Users can select their own documents" ON "public"."document_files" FOR SELECT TO "authenticated" USING (("uploaded_by" = ("auth"."jwt"() ->> 'sub'::"text")));
...
CREATE POLICY "Users can unlink their documents" ON "public"."bsi_transactions_document_files" FOR DELETE USING (((EXISTS ( SELECT 1
   FROM "public"."document_files" "df"
  WHERE (("df"."id" = "bsi_transactions_document_files"."document_file_id") AND ("df"."uploaded_by" = ("auth"."jwt"() ->> 'sub'::"text"))))) OR (EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users"
  WHERE (("auth_clerk_users"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("auth_clerk_users"."role" = 'admin'::"public"."user_role_internal"))))));
...
CREATE POLICY "Users can view distributions in their organizations" ON "public"."bsi_distributions" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."auth_clerk_orgs_members" "m"
     JOIN "public"."auth_clerk_users" "p" ON (("p"."id" = "m"."auth_clerk_users_id")))
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("m"."clerk_org_id" = "bsi_distributions"."clerk_org_id")))));



CREATE POLICY "Users can view documents for their transactions" ON "public"."bsi_transactions_document_files" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM ("public"."bsi_transactions" "t"
     JOIN "public"."bsi_transactions_investors" "ti" ON (("t"."id" = "ti"."transaction_id")))
...
CREATE POLICY "Users can view transaction deal allocations" ON "public"."bsi_transactions_deals" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM ("public"."bsi_transactions" "t"
     JOIN "public"."bsi_transactions_investors" "ti" ON (("t"."id" = "ti"."transaction_id")))
...
CREATE POLICY "Users can view transaction instrument allocations" ON "public"."bsi_transactions_instruments" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM ("public"."bsi_transactions" "t"
     JOIN "public"."bsi_transactions_investors" "ti" ON (("t"."id" = "ti"."transaction_id")))
...
CREATE POLICY "contact_contact_types_delete_authenticated" ON "public"."contact_contact_types" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "contact_contact_types_insert_authenticated" ON "public"."contact_contact_types" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "contact_contact_types_update_authenticated" ON "public"."contact_contact_types" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "deal_guarantors_delete_authenticated" ON "public"."deal_guarantors" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "deal_guarantors_insert_authenticated" ON "public"."deal_guarantors" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "deal_guarantors_select_authenticated" ON "public"."deal_guarantors" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "deal_guarantors_update_authenticated" ON "public"."deal_guarantors" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "deal_roles_delete_authenticated" ON "public"."deal_roles" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "deal_roles_insert_authenticated" ON "public"."deal_roles" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "deal_roles_select_authenticated" ON "public"."deal_roles" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "deal_roles_update_authenticated" ON "public"."deal_roles" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
ALTER TABLE "public"."document_investors" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "org_themes_admin_all" ON "public"."auth_clerk_orgs_themes" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "u"
  WHERE (("u"."clerk_user_id" = (("current_setting"('request.jwt.claims'::"text", true))::json ->> 'sub'::"text")) AND ("u"."role" = 'admin'::"public"."user_role_internal")))));



CREATE POLICY "org_themes_member_read" ON "public"."auth_clerk_orgs_themes" FOR SELECT USING (true);
...
GRANT ALL ON TABLE "public"."document_investors" TO "anon";
GRANT ALL ON TABLE "public"."document_investors" TO "authenticated";
GRANT ALL ON TABLE "public"."document_investors" TO "service_role";
...
GRANT ALL ON TABLE "public"."transaction_documents_view" TO "authenticated";
GRANT ALL ON TABLE "public"."transaction_documents_view" TO "service_role";
