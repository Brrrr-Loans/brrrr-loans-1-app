...
ALTER VIEW "public"."storage_objects_view" OWNER TO "postgres";


COMMENT ON VIEW "public"."storage_objects_view" IS 'View for querying storage objects - admin access only via is_internal_admin()';
...
COMMENT ON VIEW "public"."transaction_documents_view" IS 'View joining transaction documents with file details for easier querying';
...
CREATE INDEX "idx_bsi_distributions_statement_id" ON "public"."bsi_distributions" USING "btree" ("statement_id");
...
CREATE INDEX "idx_document_investors_investor" ON "public"."document_investors" USING "btree" ("investor_type", "investor_id");



CREATE INDEX "idx_document_investors_path" ON "public"."document_investors" USING "btree" ("document_path", "bucket_name");
...
ALTER TABLE ONLY "public"."bsi_distributions"
    ADD CONSTRAINT "bsi_distributions_statement_id_fkey" FOREIGN KEY ("statement_id") REFERENCES "public"."bsi_statements"("id");
...
CREATE POLICY "Admins can view all organization memberships" ON "public"."auth_clerk_orgs_members" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("p"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Org members can read linked deals" ON "public"."bsi_deals_orgs" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."auth_clerk_users" "p"
     JOIN "public"."auth_clerk_orgs_members" "m" ON (("p"."id" = "m"."auth_clerk_users_id")))
  WHERE (("m"."clerk_org_id" = "bsi_deals_orgs"."clerk_org_id") AND ("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text"))))));
...
CREATE POLICY "Users can view their own organization memberships" ON "public"."auth_clerk_orgs_members" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "p"
  WHERE (("p"."id" = "auth_clerk_orgs_members"."auth_clerk_users_id") AND ("p"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text"))))));
...
CREATE POLICY "Users can view their transaction allocations" ON "public"."bsi_transactions_investors" FOR SELECT USING ((("clerk_user_id" IN ( SELECT "auth_clerk_users"."id"
   FROM "public"."auth_clerk_users"
  WHERE ("auth_clerk_users"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")))) OR (EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users"
  WHERE (("auth_clerk_users"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("auth_clerk_users"."role" = 'admin'::"public"."user_role_internal"))))));
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."document_files" TO "anon";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_deals" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_deals" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_deals" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_deals_orgs" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_deals_orgs" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_deals_orgs" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."bsi_transactions_document_files" TO "anon";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."contact_types_jt" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."contact_types_jt" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."contact_types_jt" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."storage_objects_view" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."storage_objects_view" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."storage_objects_view" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."transaction_documents_view" TO "anon";
