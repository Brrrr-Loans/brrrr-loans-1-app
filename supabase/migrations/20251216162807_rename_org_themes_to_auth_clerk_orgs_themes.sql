...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'org_themes')
    ...
    ALTER TABLE public.auth_clerk_orgs_themes 
      RENAME CONSTRAINT org_themes_org_id_fkey TO org_themes_org_id_fkey;
    ALTER TABLE public.auth_clerk_orgs_themes 
      RENAME CONSTRAINT org_themes_created_by_user_id_fkey TO org_themes_created_by_user_id_fkey;
