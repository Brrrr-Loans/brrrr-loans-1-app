-- Migration: Update sync function to use junction table for transfer-vendor matching
-- Stage 1: Use api_brex_transfers_vendors instead of relying on counterparty_id
...
'Syncs matched Brex transfers to bsi_transactions using junction table (api_brex_transfers_vendors). Supports both automatic and manual matches. Inserts new transactions and updates existing ones.';
