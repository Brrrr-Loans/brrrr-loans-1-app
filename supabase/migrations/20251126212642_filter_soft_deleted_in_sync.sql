-- Migration: Update sync function to filter out soft-deleted matches
...
'Syncs matched Brex transfers to bsi_transactions. Filters out soft-deleted matches. From investor perspective: negative amounts = contributions (money out), positive amounts = distributions (money in).';
