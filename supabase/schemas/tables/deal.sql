-- Table: public.deal
-- Note: Party assignments (broker, title agent, etc.) are now in deal_parties junction table
-- Note: Guarantor assignments are now in deals_guarantors junction table
...
-- Note: The following columns have been moved to junction tables:
-- MOVED TO deal_parties:
--   broker_id, title_company_contact_id, insurance_carrier_contact_id,
--   closing_agent_contact_id, appraisal_poc_contact_id, loan_buyer_contact_id,
--   escrow_contact_id, account_executive_id, loan_processor_id, loan_opener_id
-- MOVED TO deals_guarantors:
--   primary_guarantor_id, second_guarantor_id, third_guarantor_id, fourth_guarantor_id
