...
CREATE OR REPLACE FUNCTION "public"."can_access_borrower_document"("p_borrower_id" bigint) RETURNS boolean
...
ALTER FUNCTION "public"."can_access_borrower_document"("p_borrower_id" bigint) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."can_access_borrower_document"("p_borrower_id" bigint) IS 'Returns true if user can access documents linked to this borrower (via user/org/deal link)';



CREATE OR REPLACE FUNCTION "public"."can_access_company_document"("p_company_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."can_access_company_document"("p_company_id" bigint) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."can_access_company_document"("p_company_id" bigint) IS 'Returns true if user can access documents linked to this company (via user/org/deal link)';
...
COMMENT ON FUNCTION "public"."can_access_deal_document"("p_deal_id" bigint, "p_document_category_id" bigint, "p_action" "text") IS 'Check if current user can perform an action on a document category (by ID) for a specific deal';
...
CREATE OR REPLACE FUNCTION "public"."can_access_guarantor_document"("p_guarantor_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."can_access_guarantor_document"("p_guarantor_id" bigint) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."can_access_guarantor_document"("p_guarantor_id" bigint) IS 'Returns true if user can access documents linked to this guarantor (via user/org/deal link)';



CREATE OR REPLACE FUNCTION "public"."can_access_property_document"("p_property_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."can_access_property_document"("p_property_id" bigint) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."can_access_property_document"("p_property_id" bigint) IS 'Returns true if user can access documents linked to this property (via user/org/deal link)';
...
COMMENT ON FUNCTION "public"."is_org_admin"("p_org_id" bigint) IS 'Returns true if user has clerk_org_role = admin for the specified org (or active org from JWT)';
...
CREATE OR REPLACE FUNCTION "public"."user_can_access_document"("p_document_file_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    SET "row_security" TO 'off'
    AS $$
...
ALTER FUNCTION "public"."user_can_access_document"("p_document_file_id" bigint) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."user_can_access_document"("p_document_file_id" bigint) IS 'Returns true if user can access the document (uploader or has deal role). Uses SECURITY DEFINER + row_security=off.';
...
COMMENT ON TABLE "public"."_function_backups_20251118" IS 'Backup table used for rollback on 2025-11-18. Can be dropped after confirming stability.';
...
COMMENT ON COLUMN "public"."api_brex_transfers_vendors"."created_by_user_id" IS 'User who created the match (NULL for automatic matches)';



COMMENT ON COLUMN "public"."api_brex_transfers_vendors"."updated_by_user_id" IS 'User who last updated the match';
...
COMMENT ON COLUMN "public"."api_brex_transfers_vendors"."deleted_by_user_id" IS 'User who soft-deleted the match';
...
COMMENT ON COLUMN "public"."api_ofb_transfers"."record_transfer_name" IS 'Descriptive name for the transfer record';



COMMENT ON COLUMN "public"."api_ofb_transfers"."transfer_entered_by" IS 'User who entered the transfer in the bank system';



COMMENT ON COLUMN "public"."api_ofb_transfers"."transfer_created_at" IS 'Timestamp when transfer was created in bank system';



COMMENT ON COLUMN "public"."api_ofb_transfers"."bank_trace_number" IS 'Bank internal trace number';



COMMENT ON COLUMN "public"."api_ofb_transfers"."fed_reference_number" IS 'Federal Reserve reference number for wire';



COMMENT ON COLUMN "public"."api_ofb_transfers"."approver_one_name" IS 'Name of first approver';



COMMENT ON COLUMN "public"."api_ofb_transfers"."approver_one_timestamp" IS 'Timestamp of first approval';



COMMENT ON COLUMN "public"."api_ofb_transfers"."originating_account_name" IS 'Name of originating bank account';



COMMENT ON COLUMN "public"."api_ofb_transfers"."originating_account_number" IS 'Account number (masked) of originating account';



COMMENT ON COLUMN "public"."api_ofb_transfers"."counterparty_address_line_1" IS 'Counterparty address line 1';



COMMENT ON COLUMN "public"."api_ofb_transfers"."counterparty_address_line_2" IS 'Counterparty address line 2';



COMMENT ON COLUMN "public"."api_ofb_transfers"."counterparty_address_line_3" IS 'Counterparty address line 3';



COMMENT ON COLUMN "public"."api_ofb_transfers"."counterparty_beneficiary_bank_name" IS 'Name of counterparty beneficiary bank';



COMMENT ON COLUMN "public"."api_ofb_transfers"."external_memo_lines" IS 'Array of external memo lines (up to 6)';



COMMENT ON COLUMN "public"."api_ofb_transfers"."currency" IS 'Currency code (default USD)';
...
COMMENT ON COLUMN "public"."api_ofb_vendors"."payment_instrument_id" IS 'Payment instrument ID from bank';



COMMENT ON COLUMN "public"."api_ofb_vendors"."bank_account_type" IS 'Bank account type (CHECKING, SAVINGS, etc.)';



COMMENT ON COLUMN "public"."api_ofb_vendors"."payment_account_address_line1" IS 'Address line 1';



COMMENT ON COLUMN "public"."api_ofb_vendors"."payment_account_address_line2" IS 'Address line 2';



COMMENT ON COLUMN "public"."api_ofb_vendors"."vendor_type" IS 'Manual categorization (e.g., supplier, contractor, landlord)';
...
COMMENT ON TABLE "public"."bank_accounts" IS 'Stores bank account configurations for integrations (OFB, Brex, etc.)';



COMMENT ON COLUMN "public"."bank_accounts"."bank_code" IS 'Unique code used in application code (e.g., ofb, brex)';



COMMENT ON COLUMN "public"."bank_accounts"."csv_column_mapping" IS 'Saved column mappings for repeat CSV imports';
...
COMMENT ON TABLE "public"."bsi_deals_clerk_users" IS 'Balance Sheet Investor deals - links deals to authenticated users. Previously had redundant contact_id and contact_types_id columns removed in this migration.';



COMMENT ON COLUMN "public"."bsi_deals_clerk_users"."clerk_user_id" IS 'Foreign key to auth_clerk_users for direct user association with deals';
...
ALTER TABLE ONLY "public"."bsi_transactions" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."bsi_transactions" OWNER TO "postgres";


COMMENT ON COLUMN "public"."bsi_transactions"."clerk_user_id" IS 'Links transaction to an individual Clerk user (for investors without org entities)';
...
COMMENT ON TABLE "public"."deal_roles" IS 'Junction table linking deals to parties (contacts or users) with their role on that specific deal';
...
COMMENT ON TABLE "public"."document_access_permissions" IS 'Permission matrix defining which deal roles can access which document categories';



COMMENT ON COLUMN "public"."document_access_permissions"."can_view" IS 'Can view/download documents in this category';



COMMENT ON COLUMN "public"."document_access_permissions"."can_insert" IS 'Can create new document records in this category';



COMMENT ON COLUMN "public"."document_access_permissions"."can_upload" IS 'Can upload/replace files for documents in this category';



COMMENT ON COLUMN "public"."document_access_permissions"."can_delete" IS 'Can delete documents in this category';
...
COMMENT ON VIEW "public"."view_document_categories_user_order" IS 'Document categories with user-specific display order (falls back to system default)';



CREATE OR REPLACE VIEW "public"."view_rbac_permissions_summary" AS
 SELECT "role",
    "resource_type",
...
COMMENT ON VIEW "public"."view_rbac_permissions_summary" IS 'Aggregated view of permissions by role and resource type for auditing';



CREATE OR REPLACE VIEW "public"."view_storage_objects" AS
 SELECT "id",
    "name",
    "bucket_id",
    "owner",
...
COMMENT ON VIEW "public"."view_storage_objects" IS 'Admin-only view of storage objects. Access controlled by is_internal_admin() function.';
...
ALTER TABLE ONLY "public"."auth_clerk_orgs_themes"
    ADD CONSTRAINT "auth_clerk_orgs_themes_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."document_access_permissions"
    ADD CONSTRAINT "document_access_permissions_unique" UNIQUE ("deal_role_types_id", "document_categories_id");
...
CREATE INDEX "idx_doc_access_perm_category" ON "public"."document_access_permissions" USING "btree" ("document_categories_id");



CREATE INDEX "idx_doc_access_perm_role" ON "public"."document_access_permissions" USING "btree" ("deal_role_types_id");
...
ALTER TABLE ONLY "public"."auth_clerk_orgs_themes"
    ADD CONSTRAINT "auth_clerk_orgs_themes_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "public"."auth_clerk_users"("id");



ALTER TABLE ONLY "public"."auth_clerk_orgs_themes"
    ADD CONSTRAINT "auth_clerk_orgs_themes_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."auth_clerk_orgs"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."weweb_auth_users_roles"
    ADD CONSTRAINT "users_roles_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "public"."weweb_auth_roles"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admin can delete deals" ON "public"."deal" FOR DELETE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admin can insert deals" ON "public"."deal" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admin can manage document_files_borrowers" ON "public"."document_files_borrowers" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin can manage document_files_clerk_orgs" ON "public"."document_files_clerk_orgs" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin can manage document_files_clerk_users" ON "public"."document_files_clerk_users" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin can manage document_files_companies" ON "public"."document_files_companies" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin can manage document_files_guarantors" ON "public"."document_files_guarantors" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin can manage document_files_properties" ON "public"."document_files_properties" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admin can read task templates" ON "public"."task_templates" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admin can select all deals" ON "public"."deal" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admin can update deals" ON "public"."deal" FOR UPDATE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admin full access to document_deals" ON "public"."document_files_deals" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin full access to documents" ON "public"."document_files" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin manages document_files_tags" ON "public"."document_files_tags" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Allow auth select" ON "public"."borrower" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Allow auth select" ON "public"."guarantor" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Allow auth select" ON "public"."property" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "Internal users can delete contact type links" ON "public"."contact_contact_types" FOR DELETE TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "Internal users can manage contact type links" ON "public"."contact_contact_types" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Internal users can update contact type links" ON "public"."contact_contact_types" FOR UPDATE TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Org admins manage own org document links" ON "public"."document_files_clerk_orgs" TO "authenticated" USING ("public"."is_org_admin"("clerk_org_id")) WITH CHECK ("public"."is_org_admin"("clerk_org_id"));



CREATE POLICY "Org admins view document_access_permissions" ON "public"."document_access_permissions" FOR SELECT TO "authenticated" USING ("public"."is_org_admin"());
...
CREATE POLICY "Org members can view document_files_clerk_orgs links" ON "public"."document_files_clerk_orgs" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_orgs_members" "m"
  WHERE (("m"."auth_clerk_users_id" = "public"."get_current_user_id"()) AND ("m"."clerk_org_id" = "document_files_clerk_orgs"."clerk_org_id")))));



CREATE POLICY "Public can view roles" ON "public"."weweb_auth_roles" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Public can view users_roles" ON "public"."weweb_auth_users_roles" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "Users can view borrower documents for their deals" ON "public"."document_files_borrowers" FOR SELECT TO "authenticated" USING ("public"."can_access_borrower_document"("borrower_id"));
...
CREATE POLICY "Users can view company documents for their deals" ON "public"."document_files_companies" FOR SELECT TO "authenticated" USING ("public"."can_access_company_document"("company_id"));
...
CREATE POLICY "Users can view guarantor documents for their deals" ON "public"."document_files_guarantors" FOR SELECT TO "authenticated" USING ("public"."can_access_guarantor_document"("guarantor_id"));
...
CREATE POLICY "Users can view own document_files_clerk_users links" ON "public"."document_files_clerk_users" FOR SELECT TO "authenticated" USING (("clerk_user_id" = "public"."get_current_user_id"()));
...
CREATE POLICY "Users can view own uploads" ON "public"."document_files" FOR SELECT TO "authenticated" USING (("uploaded_by" = ("auth"."jwt"() ->> 'sub'::"text")));
...
CREATE POLICY "Users can view property documents for their deals" ON "public"."document_files_properties" FOR SELECT TO "authenticated" USING ("public"."can_access_property_document"("property_id"));
...
CREATE POLICY "Users can view tags for accessible docs" ON "public"."document_files_tags" FOR SELECT TO "authenticated" USING ("public"."user_can_access_document"("document_file_id"));
...
CREATE POLICY "Users view document_files_deals via role" ON "public"."document_files_deals" FOR SELECT TO "authenticated" USING ("public"."check_user_deal_role"("deal_id"));
...
CREATE POLICY "contact_contact_types_select_authenticated" ON "public"."contact_contact_types" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "document_access_permissions_admin_all" ON "public"."document_access_permissions" TO "authenticated" USING ("public"."is_internal_admin"()) WITH CHECK ("public"."is_internal_admin"());



CREATE POLICY "document_access_permissions_select_authenticated" ON "public"."document_access_permissions" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON FUNCTION "public"."can_access_borrower_document"("p_borrower_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_borrower_document"("p_borrower_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_borrower_document"("p_borrower_id" bigint) TO "service_role";



GRANT ALL ON FUNCTION "public"."can_access_company_document"("p_company_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_company_document"("p_company_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_company_document"("p_company_id" bigint) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."can_access_guarantor_document"("p_guarantor_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_guarantor_document"("p_guarantor_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_guarantor_document"("p_guarantor_id" bigint) TO "service_role";



GRANT ALL ON FUNCTION "public"."can_access_property_document"("p_property_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_property_document"("p_property_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_property_document"("p_property_id" bigint) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_can_access_document"("p_document_file_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."user_can_access_document"("p_document_file_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_can_access_document"("p_document_file_id" bigint) TO "service_role";
...
GRANT ALL ON TABLE "public"."_function_backups_20251118" TO "anon";
GRANT ALL ON TABLE "public"."_function_backups_20251118" TO "authenticated";
GRANT ALL ON TABLE "public"."_function_backups_20251118" TO "service_role";



GRANT ALL ON TABLE "public"."api_brex_transfers" TO "anon";
GRANT ALL ON TABLE "public"."api_brex_transfers" TO "authenticated";
GRANT ALL ON TABLE "public"."api_brex_transfers" TO "service_role";
...
GRANT ALL ON TABLE "public"."api_brex_transfers_vendors" TO "anon";
GRANT ALL ON TABLE "public"."api_brex_transfers_vendors" TO "authenticated";
...
GRANT ALL ON TABLE "public"."api_brex_vendors" TO "anon";
GRANT ALL ON TABLE "public"."api_brex_vendors" TO "authenticated";
GRANT ALL ON TABLE "public"."api_brex_vendors" TO "service_role";



GRANT ALL ON TABLE "public"."api_brex_vendors_clerk_orgs" TO "anon";
GRANT ALL ON TABLE "public"."api_brex_vendors_clerk_orgs" TO "authenticated";
GRANT ALL ON TABLE "public"."api_brex_vendors_clerk_orgs" TO "service_role";
...
GRANT ALL ON TABLE "public"."api_brex_vendors_clerk_users" TO "anon";
GRANT ALL ON TABLE "public"."api_brex_vendors_clerk_users" TO "authenticated";
GRANT ALL ON TABLE "public"."api_brex_vendors_clerk_users" TO "service_role";
...
GRANT ALL ON TABLE "public"."api_ofb_transfers" TO "anon";
GRANT ALL ON TABLE "public"."api_ofb_transfers" TO "authenticated";
GRANT ALL ON TABLE "public"."api_ofb_transfers" TO "service_role";
...
GRANT ALL ON TABLE "public"."api_ofb_transfers_vendors" TO "anon";
GRANT ALL ON TABLE "public"."api_ofb_transfers_vendors" TO "authenticated";
GRANT ALL ON TABLE "public"."api_ofb_transfers_vendors" TO "service_role";
...
GRANT ALL ON TABLE "public"."api_ofb_vendors" TO "anon";
GRANT ALL ON TABLE "public"."api_ofb_vendors" TO "authenticated";
GRANT ALL ON TABLE "public"."api_ofb_vendors" TO "service_role";



GRANT ALL ON TABLE "public"."api_ofb_vendors_clerk_orgs" TO "anon";
GRANT ALL ON TABLE "public"."api_ofb_vendors_clerk_orgs" TO "authenticated";
GRANT ALL ON TABLE "public"."api_ofb_vendors_clerk_orgs" TO "service_role";
...
GRANT ALL ON TABLE "public"."api_ofb_vendors_clerk_users" TO "anon";
GRANT ALL ON TABLE "public"."api_ofb_vendors_clerk_users" TO "authenticated";
GRANT ALL ON TABLE "public"."api_ofb_vendors_clerk_users" TO "service_role";
...
GRANT ALL ON TABLE "public"."auth_clerk_orgs_themes" TO "anon";
GRANT ALL ON TABLE "public"."auth_clerk_orgs_themes" TO "authenticated";
GRANT ALL ON TABLE "public"."auth_clerk_orgs_themes" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_deals_clerk_orgs" TO "anon";
GRANT ALL ON TABLE "public"."bsi_deals_clerk_orgs" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_deals_clerk_orgs" TO "service_role";



GRANT ALL ON TABLE "public"."bsi_deals_clerk_users" TO "anon";
GRANT ALL ON TABLE "public"."bsi_deals_clerk_users" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_deals_clerk_users" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_distributions_transactions" TO "anon";
GRANT ALL ON TABLE "public"."bsi_distributions_transactions" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_distributions_transactions" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_statements_transactions" TO "anon";
GRANT ALL ON TABLE "public"."bsi_statements_transactions" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_statements_transactions" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_transactions_document_files" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_transactions_document_files" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_transactions_api_brex_transfers" TO "anon";
GRANT ALL ON TABLE "public"."bsi_transactions_api_brex_transfers" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_transactions_api_brex_transfers" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_transactions_api_ofb_transfers" TO "anon";
GRANT ALL ON TABLE "public"."bsi_transactions_api_ofb_transfers" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_transactions_api_ofb_transfers" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_transactions_deals" TO "anon";
GRANT ALL ON TABLE "public"."bsi_transactions_deals" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_transactions_deals" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_transactions_instruments" TO "anon";
GRANT ALL ON TABLE "public"."bsi_transactions_instruments" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_transactions_instruments" TO "service_role";
...
GRANT ALL ON TABLE "public"."bsi_transactions_investors" TO "anon";
GRANT ALL ON TABLE "public"."bsi_transactions_investors" TO "authenticated";
GRANT ALL ON TABLE "public"."bsi_transactions_investors" TO "service_role";
...
GRANT ALL ON TABLE "public"."contact_contact_types" TO "anon";
GRANT ALL ON TABLE "public"."contact_contact_types" TO "authenticated";
GRANT ALL ON TABLE "public"."contact_contact_types" TO "service_role";
...
GRANT ALL ON TABLE "public"."document_files_companies" TO "anon";
...
GRANT ALL ON TABLE "public"."document_files_guarantors" TO "anon";
...
GRANT ALL ON TABLE "public"."document_files_properties" TO "anon";
...
GRANT ALL ON TABLE "public"."payroll_ledger" TO "anon";
GRANT ALL ON TABLE "public"."payroll_ledger" TO "authenticated";
GRANT ALL ON TABLE "public"."payroll_ledger" TO "service_role";



GRANT ALL ON TABLE "public"."payroll_ledger_fees_1099" TO "anon";
GRANT ALL ON TABLE "public"."payroll_ledger_fees_1099" TO "authenticated";
GRANT ALL ON TABLE "public"."payroll_ledger_fees_1099" TO "service_role";
...
GRANT ALL ON TABLE "public"."view_document_categories_user_order" TO "anon";
GRANT ALL ON TABLE "public"."view_document_categories_user_order" TO "authenticated";
GRANT ALL ON TABLE "public"."view_document_categories_user_order" TO "service_role";



GRANT ALL ON TABLE "public"."view_rbac_permissions_summary" TO "anon";
GRANT ALL ON TABLE "public"."view_rbac_permissions_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."view_rbac_permissions_summary" TO "service_role";



GRANT ALL ON TABLE "public"."view_storage_objects" TO "anon";
GRANT ALL ON TABLE "public"."view_storage_objects" TO "authenticated";
GRANT ALL ON TABLE "public"."view_storage_objects" TO "service_role";



GRANT ALL ON TABLE "public"."view_transaction_documents" TO "anon";
GRANT ALL ON TABLE "public"."view_transaction_documents" TO "authenticated";
GRANT ALL ON TABLE "public"."view_transaction_documents" TO "service_role";



GRANT ALL ON TABLE "public"."weweb_auth_roles" TO "anon";
GRANT ALL ON TABLE "public"."weweb_auth_roles" TO "authenticated";
GRANT ALL ON TABLE "public"."weweb_auth_roles" TO "service_role";



GRANT ALL ON TABLE "public"."weweb_auth_users_roles" TO "anon";
GRANT ALL ON TABLE "public"."weweb_auth_users_roles" TO "authenticated";
GRANT ALL ON TABLE "public"."weweb_auth_users_roles" TO "service_role";
