...
GRANT ALL ON TABLE "public"."deal_document_participants" TO "anon";
GRANT ALL ON TABLE "public"."deal_document_participants" TO "authenticated";
GRANT ALL ON TABLE "public"."deal_document_participants" TO "service_role";
