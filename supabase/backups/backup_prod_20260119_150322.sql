...
COMMENT ON FUNCTION "public"."can_access_deal_document"("p_deal_id" bigint, "p_document_category_code" "text", "p_action" "text") IS 'Check if current user can perform an action on a document category for a specific deal';
...
COMMENT ON VIEW "public"."view_transaction_documents" IS 'Joins transaction document files with document metadata. Uses storage_bucket and storage_path for file location. SECURITY INVOKER ensures RLS is enforced for the calling user.';
...
CREATE POLICY "Admin can delete documents" ON "public"."document_files" FOR DELETE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admin can insert documents" ON "public"."document_files" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admin can manage document_files_deals" ON "public"."document_files_deals" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admin can manage document_files_tags" ON "public"."document_files_tags" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admin can select all documents" ON "public"."document_files" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admin can update documents" ON "public"."document_files" FOR UPDATE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Users can read document_files_tags" ON "public"."document_files_tags" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
