...
COMMENT ON VIEW "public"."transaction_documents_view" IS 'Joins transaction document files with document metadata. Uses storage_bucket and storage_path for file location. SECURITY INVOKER ensures RLS is enforced for the calling user.';
