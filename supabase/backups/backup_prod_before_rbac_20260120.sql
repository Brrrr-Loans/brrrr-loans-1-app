...
COMMENT ON FUNCTION "public"."count_pending_brex_transfer_syncs"() IS 'Returns the count of Brex transfers that are matched to vendors but have not yet been synced to bsi_transactions.';
...
COMMENT ON FUNCTION "public"."sync_matched_api_brex_transfers_to_bsi_transactions"() IS 'Syncs matched Brex transfers to bsi_transactions. Filters out soft-deleted matches. From investor perspective: negative amounts = contributions (money out), positive amounts = distributions (money in).';
...
CREATE TABLE IF NOT EXISTS "public"."contacts_contact_types" (
    "id" bigint NOT NULL,
...
ALTER TABLE "public"."contacts_contact_types" OWNER TO "postgres";


COMMENT ON TABLE "public"."contacts_contact_types" IS 'Junction table linking contacts to their contact types (many-to-many)';



COMMENT ON COLUMN "public"."contacts_contact_types"."contact_id" IS 'Foreign key to contact.id';



COMMENT ON COLUMN "public"."contacts_contact_types"."contact_types_id" IS 'Foreign key to contact_types.id';



ALTER TABLE "public"."contacts_contact_types" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE ONLY "public"."contacts_contact_types"
...
CREATE POLICY "Admin can manage contact type junctions" ON "public"."contacts_contact_types" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admin can select all distributions" ON "public"."bsi_distributions" FOR SELECT TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admins can delete distributions" ON "public"."bsi_distributions" FOR DELETE TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "Admins can delete instrument-deal links" ON "public"."bs_debt_instruments_deals" FOR DELETE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Admins can insert distributions" ON "public"."bsi_distributions" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admins can insert instrument-deal links" ON "public"."bs_debt_instruments_deals" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_admin"());
...
CREATE POLICY "Admins can update distributions" ON "public"."bsi_distributions" FOR UPDATE TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "Admins can update instrument-deal links" ON "public"."bs_debt_instruments_deals" FOR UPDATE TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "All authenticated users can read contact type junctions" ON "public"."contacts_contact_types" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "contact_contact_types_delete_authenticated" ON "public"."contacts_contact_types" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "contact_contact_types_insert_authenticated" ON "public"."contacts_contact_types" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "contact_contact_types_select_authenticated" ON "public"."contacts_contact_types" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "contact_contact_types_update_authenticated" ON "public"."contacts_contact_types" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
ALTER TABLE "public"."contacts_contact_types" ENABLE ROW LEVEL SECURITY;
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."payroll_ledger";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."contacts_contact_types" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."contacts_contact_types" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."contacts_contact_types" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."document_access_permissions" TO "anon";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."document_access_permissions" TO "service_role";
