...
CREATE OR REPLACE VIEW "public"."transaction_documents_view" WITH ("security_invoker"='on') AS
...
CREATE TABLE IF NOT EXISTS "public"."wf_form_footer_subscribe" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "first_name" "text",
    "last_name" "text",
    "email" "text",
...
ALTER TABLE "public"."wf_form_footer_subscribe" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."wf_form_footer_subscribe"
    ADD CONSTRAINT "wf_form_subscribe_newsletter_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_wf_form_footer_subscribe_email" ON "public"."wf_form_footer_subscribe" USING "btree" ("lower"("email"));
...
CREATE POLICY "Admin can view all transactions" ON "public"."bsi_transactions" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users" "aup"
  WHERE (("aup"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")) AND ("aup"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Admins can manage bsi_distributions_transactions" ON "public"."bsi_distributions_transactions" USING ((EXISTS ( SELECT 1
...
CREATE POLICY "Admins can manage bsi_statements_transactions" ON "public"."bsi_statements_transactions" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users"
  WHERE (("auth_clerk_users"."clerk_user_id" = ( SELECT ("auth"."jwt"() ->> 'sub'::"text"))) AND ("auth_clerk_users"."role" = 'admin'::"public"."user_role_internal")))));
...
CREATE POLICY "Enable read access for all users" ON "public"."wf_form_footer_subscribe" FOR SELECT USING (true);
...
CREATE POLICY "Org admins can create themes" ON "public"."auth_clerk_orgs_themes" FOR INSERT WITH CHECK (("org_id" IN ( SELECT "auth_clerk_orgs_members"."clerk_org_id"
   FROM "public"."auth_clerk_orgs_members"
  WHERE (("auth_clerk_orgs_members"."auth_clerk_users_id" = ( SELECT "auth_clerk_users"."id"
           FROM "public"."auth_clerk_users"
          WHERE ("auth_clerk_users"."clerk_user_id" = ("auth"."jwt"() ->> 'sub'::"text")))) AND ("auth_clerk_orgs_members"."clerk_org_role" = 'admin'::"public"."clerk_org_role")))));
...
CREATE POLICY "Org members can view their org themes" ON "public"."auth_clerk_orgs_themes" FOR SELECT USING (("org_id" IN ( SELECT "auth_clerk_orgs_members"."clerk_org_id"
   FROM "public"."auth_clerk_orgs_members"
  WHERE ("auth_clerk_orgs_members"."auth_clerk_users_id" = ( SELECT "auth_clerk_users"."id"
           FROM "public"."auth_clerk_users"
...
CREATE POLICY "Platform admins have full access" ON "public"."auth_clerk_orgs_themes" USING ((EXISTS ( SELECT 1
   FROM "public"."auth_clerk_users"
...
CREATE POLICY "Users can view their transactions" ON "public"."bsi_transactions" FOR SELECT TO "authenticated" USING ("public"."user_has_transaction_access"("id"));
...
CREATE POLICY "allow_all_authenticated_select" ON "public"."deal" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "dev_allow_all_authenticated_select" ON "public"."bsi_transactions" FOR SELECT TO "authenticated" USING (true);
...
ALTER TABLE "public"."wf_form_footer_subscribe" ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."document_investors" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."transaction_documents_view" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."transaction_documents_view" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."wf_form_footer_subscribe" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."wf_form_footer_subscribe" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."wf_form_footer_subscribe" TO "service_role";
