...
// Ensure modal prop is set to prevent Next.js dialog backdrop conflicts
// Default to modal={true} but allow override
const Dialog = ((
  props: React.ComponentPropsWithoutRef<typeof DialogPrimitive.Root>
) => {
  // Default to modal={true} if not explicitly set to false
