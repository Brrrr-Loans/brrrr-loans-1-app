...
import { MAIN_NAV_ITEMS, BALANCE_SHEET_NAV_ITEMS, TOOLS_NAV_ITEMS } from "@/config/navigation";
...
const NavTools = dynamic(
  () => import("./nav-tools").then((mod) => mod.NavTools),
  { ssr: false }
);
  ...
  return (
    <Sidebar {...props}>
      ...
      <SidebarContent>
        ...
        <NavTools items={TOOLS_NAV_ITEMS} />
      </SidebarContent>
